...
import '../../cubit/maps_states.dart';

class MapAds extends StatefulWidget {
  const MapAds({super.key});

  @override
  State<MapAds> createState() => _MapAdsState();
}

class _MapAdsState extends State<MapAds> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    super.build(context);
    return BlocProvider(
      create: (context) => MapsCubit()..getMapAds(),
